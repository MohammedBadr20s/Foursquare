...
class LocationManager {
    ...
    init(locationManager: CLLocationManager, coreLocationDelegate: CLLocationManagerDelegate, viewController: UIViewController) {
        self.manager = locationManager
        self.manager.delegate = coreLocationDelegate

        checkLocationAuthorization(manager: self.manager, viewController: viewController)
    }
